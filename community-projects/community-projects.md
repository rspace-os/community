...
This Firefox extension is developed at the Leibniz Institute for Neurobiology. It reads datamatrix code from a camera and creates a sample in an inventory system to link it into an ELN.

🔗 https://github.com/SaibotMagd/dmtxSampleCreator

### RDM System Connector
This tool is developed at the Leibniz Institute for Neurobiology in Magdeburg and is designed to synchronize the entries in a four-tool system, which includes a - project registration system (eGroupware), - an electronic lab book (RSpace), - an image database (OMERO), - a long-term net storage system (LINstore).

🔗 https://github.com/SaibotMagd/RDM_system_connector

### RSpace MCP server
A proof of concept MCP server with some tools to incorporate into common AI tools like Claude, GitHub Copilot, ..

🔗 https://github.com/rspace-os/rspace-mcp

### Chrome extension for RSpace
A prototype web clipper to save web content to RSpace for Chrome and Chromium-based browsers

🔗 https://github.com/tilorspace/rspace-web-clipper
