...
Thank you for your interest in contributing to RSpace! Contributions can take many forms — we welcome them all.

**New here?** Start with [Getting Started](getting-started.md) — it covers the essentials every contributor needs to know before diving in.
...
|---|---|
| [Getting Started](getting-started.md) | Prerequisites, CLA, and how to find the right path |
